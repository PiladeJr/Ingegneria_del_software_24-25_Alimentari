...
public class SecurityConfig {
    ...
    private void eventiAuth(
        ...
        auth
                ...
                .requestMatchers(HttpMethod.PUT, "/api/eventi/{idEvento}/elimina-virtuale")
                .hasAuthority(SecurityConfig.ROLE_GESTORE)
                .requestMatchers(HttpMethod.DELETE, "/api/eventi/{idEvento}/elimina-fisico")
                .hasAuthority(SecurityConfig.ROLE_GESTORE)
                .requestMatchers(HttpMethod.DELETE, "/api/eventi/miei/{idEvento}")
                .hasAnyAuthority(SecurityConfig.ROLE_ANIMATORE, SecurityConfig.ROLE_PRODUTTORE, SecurityConfig.ROLE_TRASFORMATORE)
    ...
    private void richiestaContenutoAuth(
        ...
        auth
                ...
                .requestMatchers(HttpMethod.POST, "/api/richieste-contenuto/visita-azienda/new")
                .hasAnyAuthority(SecurityConfig.ROLE_PRODUTTORE, SecurityConfig.ROLE_TRASFORMATORE);
    }
