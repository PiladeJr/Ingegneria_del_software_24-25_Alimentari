...
public class EventoController {
     ...
     * @param order  La direzione dell'ordinamento: "asc" per crescente, "desc" per
     *               decrescente (opzionale).
     * @return {@code ResponseEntity<List<EventoEstesoDTO>>} Lista di eventi
     *         ordinati per titolo.
     */
     ...
     * <br>
     * Questo endpoint consente di recuperare un evento specifico utilizzando il suo
     * ID.
     * Se l'evento non viene trovato, restituisce un errore 404.
     *
     * @param id L'ID dell'evento da recuperare.
     * @return {@code ResponseEntity<Evento>} L'evento corrispondente o un errore
     *         404 se non trovato.
     */
     ...
     * <br>
     * Questo endpoint consente di cercare eventi che contengono il titolo
     * specificato.
     ...
     * @return {@code ResponseEntity<List<EventoEstesoDTO>>} Lista di eventi che
     *         corrispondono al titolo specificato.
     */
     ...
     * @param order  La direzione dell'ordinamento: "asc" per crescente, "desc" per
     *               decrescente (opzionale).
     * @return {@code ResponseEntity<List<EventoEstesoDTO>>} Lista di eventi creati
     *         dall'animatore.
     */
    @GetMapping("/me")
     ...
     * Se il parametro `titolo` non viene fornito, restituisce tutti gli eventi
     * creati dall'animatore.
     *
     * @param titolo Il titolo da cercare negli eventi creati dall'animatore
     *               (opzionale).
     * @return {@code ResponseEntity<List<EventoEstesoDTO>>} Lista di eventi che
     *         corrispondono al titolo specificato.
     */
     ...
     * @param order  La direzione dell'ordinamento: "asc" per crescente, "desc" per
     *               decrescente (opzionale).
     * @return {@code ResponseEntity<List<EventoEstesoDTO>>} Lista di visite
     *         aziendali create dall'animatore.
     */
     ...
     * @param order  La direzione dell'ordinamento: "asc" per crescente, "desc" per
     *               decrescente (opzionale).
     * @return {@code ResponseEntity<List<EventoEstesoDTO>>} Lista di fiere create
     *         dall'animatore.
     */
    @GetMapping("/me/fiere")
     ...
     * @param order  La direzione dell'ordinamento: "asc" per crescente, "desc" per
     *               decrescente (opzionale).
     * @return {@code ResponseEntity<List<EventoPreviewDTO>>} Lista semplificata
     *         degli eventi.
     */
     ...
     * <br>
     * Questo endpoint fornisce un elenco semplificato di tutte le fiere registrate
     * nel sistema.
     *
     * @param sortBy Il campo su cui ordinare le anteprime (opzionale).
     * @param order  La direzione dell'ordinamento: "asc" per crescente, "desc" per
     *               decrescente (opzionale).
     * @return {@code ResponseEntity<List<EventoPreviewDTO>>} Lista delle anteprime
     *         delle fiere.
     */
     ...
     * <br>
     * Questo endpoint fornisce una lista semplificata degli eventi classificati
     ...
     * <br>
     * Questo endpoint consente di cercare anteprime di eventi che contengono il
     * titolo specificato.
     * Se il parametro `titolo` non viene fornito, restituisce tutte le anteprime
     * degli eventi.
     *
     * @param titolo Il titolo da cercare nelle anteprime degli eventi (opzionale).
     * @return {@code ResponseEntity<List<EventoPreviewDTO>>} Lista di anteprime
     *         degli eventi che corrispondono al titolo specificato.
     */
     ...
     * che sono stati programmati. È possibile specificare i parametri di
     * ordinamento
     * e direzione.
     *
     * @param sortBy Il campo su cui ordinare gli eventi (opzionale, predefinito:
     *               "id").
     * @param order  La direzione dell'ordinamento: "asc" per crescente, "desc" per
     *               decrescente (opzionale, predefinito: "asc").
     * @return {@code ResponseEntity<List<EventoEstesoDTO>>} Lista di eventi visita
     *         programmati.
     */
     ...
     * @param order  La direzione dell'ordinamento: "asc" per crescente, "desc" per
     *               decrescente (opzionale, predefinito: "asc").
     * @return {@code ResponseEntity<List<EventoEstesoDTO>>} Lista di tutti gli
     *         eventi programmati.
     */
     ...
     * che contengono il titolo specificato. Se il parametro `title` non viene
     * fornito,
     * restituisce tutti gli eventi programmati ordinati per titolo in ordine
     * crescente.
     *
     ...
     * <br>
     * Questo endpoint restituisce una lista semplificata di eventi programmati con
     ...
     *               "desc" (decrescente).
     * @return {@code ResponseEntity<List<EventoPreviewDTO>>} Lista di anteprime di
     *         eventi programmati.
     */
    @GetMapping("/preview")
     ...
     * <br>
     * Questo endpoint restituisce una lista semplificata di visite programmate con
     * informazioni essenziali,
     ...
     * <br>
     * Questo endpoint restituisce una lista semplificata di fiere programmate con
     * informazioni essenziali,
     * come titolo, locandina, data di inizio e data di fine.
     *
     * @param sortBy Il campo su cui effettuare l'ordinamento. Valori supportati:
     ...
     * <br>
     * Questo endpoint restituisce una lista di anteprime di eventi programmati che
     * contengono
     * il parametro 'titolo'.
     ...
     * @param title Il titolo da cercare negli eventi(opzionale).
     * @return {@code ResponseEntity<List<EventoPreviewDTO>>} Lista di anteprime di
     *         eventi programmati che contengono il titolo specificato.
     */
     ...
     * <br>
     * Questo endpoint consente di ottenere un evento programmato specifico
     * utilizzando il suo ID.
     * Se l'evento non viene trovato, restituisce un errore 404.
     *
     * @param id L'ID dell'evento da recuperare.
     * @return {@code ResponseEntity<EventoEstesoDTO>} L'evento corrispondente o un
     ...
     * <br>
     * Questo endpoint permette di ottenere la lista degli iscritti a un evento di
     * tipo visita
     * specificato tramite il suo ID, verificando prima se il creatore dell'evento
     * corrisponde all'utente autenticato.
     *
     * @param idVisita L'ID della visita di cui recuperare gli iscritti.
     * @return {@code ResponseEntity<List<IscrittoDTO>>} Lista degli iscritti alla
     *         visita specificata.
     */
    @GetMapping("/me/visite/{idVisita}/iscritti")
     ...
     * <br>
     * Questo endpoint consente a un utente autenticato di iscriversi a un evento di
     * tipo visita.
     *
     ...
     * <br>
     * Questo endpoint consente di cancellare virtualmente un evento creato
     * dall'animatore autenticato.
     * La cancellazione virtuale non elimina fisicamente l'evento dal database, ma
     * lo rende non visibile
     * agli utenti. Se l'evento non viene trovato o non appartiene all'animatore
     * autenticato, restituisce
     * un errore.
     *
     * @param idEvento L'ID dell'evento da cancellare virtualmente.
     * @return {@code ResponseEntity<String>} Messaggio di conferma o errore.
     */
    @DeleteMapping("/me/{idEvento}")
     ...
     * <br>
     * Questo endpoint consente di eliminare virtualmente un evento specifico
     * utilizzando il suo ID.
     * Se l'evento non viene trovato, restituisce un errore 404.
     *
     ...
     * <br>
     * Questo endpoint consente di eliminare fisicamente un evento specifico
     * utilizzando il suo ID.
     * Se l'evento non viene trovato o non può essere eliminato, restituisce un
     * errore.
     *
