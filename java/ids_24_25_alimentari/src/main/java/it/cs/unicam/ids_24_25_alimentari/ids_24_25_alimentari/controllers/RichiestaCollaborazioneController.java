...
public class RichiestaCollaborazioneController {
    ...
    // try {
    // Optional<Collaborazione> richiesta =
    // richiesteCollaborazioneService.ottieniRichiestaById(id);
    // if (richiesta.isPresent()) {
    // richiesteCollaborazioneService.deleteRichiesta(id);
    // return ResponseEntity.ok(Collections.singletonMap("message", "Richiesta
    ...
    // */
    // @PostMapping(value = "/azienda", consumes =
    ...
    // * o un messaggio di errore con stato HTTP 500 (INTERNAL SERVER ERROR).
    // */
    // @PostMapping(value = "/animatore", consumes =
    // MediaType.MULTIPART_FORM_DATA_VALUE)
    ...
    // * <br>
    // * Questo metodo permette di accettare o rifiutare una richiesta di
    // collaborazione.
    ...
    // * Se la richiesta viene rifiutata, viene inviata una mail di notifica
    // all'utente.
    // *
    // * @param dto L'oggetto {@code CambiaStatoRichiestaCollaborazioneDTO}
    // contenente
    ...
    // */
    // @PatchMapping("/stato")
    // public ResponseEntity<?> elaboraRichiesta(@RequestBody
    // CambiaStatoRichiestaCollaborazioneDTO dto) {

    // Optional<Collaborazione> richiesta =
    // richiesteCollaborazioneService.ottieniRichiestaById(dto.getId());
    // if (richiesta.isPresent()) {
    ...
    // return ResponseEntity.badRequest()
    // .body(Collections.singletonMap("message", "Inserire un messaggio di
    // rifiuto"));
    // }
    // String messaggio = "La sua richiesta di collaborazione è stata rifiutata per
    ...
    // dto.getStato() ? "Richiesta accettata con successo." : "Richiesta
    // correttamente rifiutata."));
    // }
