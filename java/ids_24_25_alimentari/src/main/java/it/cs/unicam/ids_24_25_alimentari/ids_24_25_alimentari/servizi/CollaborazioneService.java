...
public class CollaborazioneService {
     ...
     * <br>
     * Questo metodo restituisce un oggetto di tipo Optional<Collaborazione> che rappresenta
     * una collaborazione identificata dall'ID specificato.
     *
     * @param id L'ID della collaborazione da cercare.
     * @return Un Optional contenente la collaborazione, se trovata; altrimenti un Optional vuoto.
     */
 ...
 * <br>
 * Questo metodo crea una nuova collaborazione per un'Azienda e la salva nel database.
 * Utilizza il `CollaborazioneDirector` per costruire l'oggetto `Collaborazione`.
 *
...
public Collaborazione creaNuovaAzienda(
    ...
    Collaborazione collaborazione = director.creaAzienda(nome, cognome, telefono, email, ruolo, denSociale, sedeLegale, sedeOperativa, iban, iva, certificato, cartaIdentita);
 ...
 * <br>
 * Questo metodo crea una nuova collaborazione per un Animatore e la salva nel database.
 * Utilizza il `CollaborazioneDirector` per costruire l'oggetto `Collaborazione`.
 *
...
public Collaborazione creaNuovoAnimatore(
    ...
    CollaborazioneDirector director = new CollaborazioneDirector();
    Collaborazione collaborazione = director.creaAnimatore(nome, cognome, telefono, email, ruolo, iban, cartaIdentita);
    return collaborazioneRepository.save(collaborazione);
}
 ...
 * <br>
 * Questo metodo crea una nuova collaborazione per un Curatore e la salva nel database.
 * Utilizza il `CollaborazioneDirector` per costruire l'oggetto `Collaborazione`.
 *
...
public Collaborazione creaNuovoCuratore(
    ...
    CollaborazioneDirector director = new CollaborazioneDirector();
    Collaborazione collaborazione = director.creaCuratore(nome, cognome, telefono, email, ruolo, iban, cartaIdentita, cv);
    return collaborazioneRepository.save(collaborazione);
}
     ...
     * Se la collaborazione fornita è null, viene lanciata un'eccezione IllegalArgumentException.
     *
